...
public class SodaCan extends GameObject {

	private Handler handler;

	private BufferedImage sodaCanSprite;

	public SodaCan(int x, int y, ID id, Handler handler) {
		super(x, y, id);
		...
		sodaCanSprite = ss.grabImage(6, 1, 32, 32);
	}
	...
	public void render(Graphics g) {
		g.drawImage(sodaCanSprite, x, y, null);
	}
